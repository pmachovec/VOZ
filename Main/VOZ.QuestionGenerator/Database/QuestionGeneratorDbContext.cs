...
namespace VOZ.QuestionGenerator.Database;

internal sealed class QuestionGeneratorDbContext(DbContextOptions<QuestionGeneratorDbContext> _options) : DbContext(_options)
{
