...
using VOZ.Shared.Presentation.Pages.QuestionnaireComponents.QuestionningComponents;
using VOZ.Shared.Resources.Translations;

namespace VOZ.Shared.Presentation.Pages.QuestionnaireComponents;

public class QuestionningBase : ComponentBase
{
    ...
    protected override void OnInitialized() => SetUpNewQuestion();
